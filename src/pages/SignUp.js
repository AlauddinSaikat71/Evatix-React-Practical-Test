...
function SignUp() {
  ...
  function onGoogleLoginFailure(res){
    alert("Unalbe to login with Google account!");
  }

  function onGitHubLoginSuccess(res){
    console.log(res);
    alert('Login Successful!');
    history.push({
      pathname:  "/"
  ...
  function onGitHubLoginFailure(res){
    alert("Unalbe to login with GitHub account!");
  }
  ...
  async function onSubmit(event){
    ...
    await fetch(`https://60e316dd6c365a0017839110.mockapi.io/evatix/sign-up`, {
      method: 'POST',
      headers : {
                ...
                <form>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="name" type="text" className="form-input w-full text-gray-800" placeholder="Enter your name" onChange={(event) => setName(event.target.value)} required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="password" type="password" className="form-input w-full text-gray-800" placeholder="Enter your password" onChange={(event) => setPassword(event.target.value)} required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-white bg-blue-600 hover:bg-blue-700 w-full" onClick={onSubmit}>Sign up</button>
                    </div>
                  </div>
                ...
                <form>
                  <div className="flex flex-wrap -mx-3 mb-3">
                    ...
                    //  authorizeUri="http://localhost:3000"
                     ...
                     buttonText={"Continue with GitHub"}></GitHubLogin>
                    </div>
                  </div>
                    ...
                    <div className="w-full px-3">
                      {/* <button className="btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center">
                       ...
                       <GoogleLogin
                        ...
                        clientId="702144936851-bhfhio9bl8g3eclqttnuloo8bfeai584.apps.googleusercontent.com"
