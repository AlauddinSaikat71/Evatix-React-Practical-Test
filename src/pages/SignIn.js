...
function SignIn() {
  ...
  async function onSubmit(event){
    ...
    await fetch(`https://60e316dd6c365a0017839110.mockapi.io/evatix/sign-in`, {
      method: 'POST',
      headers : {
    ...
    setShow(false);
    alert("Login Successful with token : " + res.token);
    history.push({
      pathname:  "/"
   });
  }).catch(() => {
        ...
        <section className="bg-gradient-to-b from-gray-100 to-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              {/* Form */}
              <Modal show={show} ariaLabel={'Modal_label'} handleClose={handleClose}> {'Loding... Please wait'} </Modal>
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-white bg-blue-600 hover:bg-blue-700 w-full" onClick={onSubmit} >Sign in</button>
                    </div>
                  </div>
                </form>
